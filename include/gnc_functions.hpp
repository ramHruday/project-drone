...
ros::Subscriber bat_s;
ros::Subscriber velocityPos;
...
int init_publisher_subscriber(ros::NodeHandle controlnode)
{
	...
	bat_s = controlnode.subscribe<sensor_msgs::BatteryState>((ros_namespace + "/mavros/battery").c_str(), 10, state_b);

	// subscribe to velocity
	velocityPos = controlnode.subscribe<geometry_msgs::TwistStamped>((ros_namespace + "/mavros/local_position/velocity").c_str(), 10, velocity_s);
